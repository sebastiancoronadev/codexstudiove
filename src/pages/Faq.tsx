...
const faqs = [
  { category: "General", questions: [
    { q: "¿Qué servicios ofrece?", a: "Desarrollo web, edición de video, configuración de Discord y Minecraft." },
    { q: "¿Cómo inicio un proyecto?", a: "Llena nuestro formulario de contacto y te responderemos con un presupuesto." },
    { q: "Tiempo de respuesta", a: "24 a 48 horas tras recibir la solicitud." },
  ]},
  { category: "Desarrollo Web", questions: [
    { q: "Tecnologías", a: "HTML5, CSS3, JavaScript, React, Vue, Angular, Node.js, PHP, Python." },
    { q: "Tiempos", a: "Desde 3 días hasta 3 meses según complejidad." },
  ]},
...
export default function Faq() {
  ...
  return (
    <>
      <SEO title="Preguntas Frecuentes" description="Resuelve tus dudas sobre servicios web, edición de video, Discord, Minecraft, pagos y precios." path="/faq" />
      <Header />
              ...
              <div key={ci}>
                ...
                <div className="space-y-4">
                  {cat.questions.map((faq, qi) => {
                    const id = `${ci}-${qi}`; const open = openIndex === id
                    return (<div key={qi} className="bg-[#111111] border border-gray-800 rounded-xl overflow-hidden">
                      <button onClick={() => setOpenIndex(open ? null : id)} className="w-full px-6 py-4 text-left flex justify-between items-center hover:bg-[#161616]">
                        ...
                        <span className={`text-sm transition-transform duration-300 ${open ? '-rotate-90 text-[#FF007F]' : 'rotate-90 text-white opacity-50'}`}>➜</span>
                      </button>
